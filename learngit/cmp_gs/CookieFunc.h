...
others:
history:
			2006.01.09 新增cf_file_copy()cf_file_move()cf_file_delzero()cf_files_move()cf_files_delzero()cf_files_del()	。
			2005.12.02 新增cf_string_tt2str()，调整cf_time_getcurrent()。
			2005.11.09 修改cf_datastru_halfsearch函数,增加内部功能。
